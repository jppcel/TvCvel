...
(function ($) {
	...
	loadYoumax = function() {	
		...
		$('#youmax').append('<div id="youmax-tabs"><span id="featured_" class="youmax-tab">Destaque</span><span id="uploads_" class="youmax-tab">Envios</span><span id="playlists_" class="youmax-tab">Playlists</span></div>');

		
		$('#youmax').append('<div id="youmax-encloser"><iframe id="youmax-video" width="'+(youmaxWidgetWidth-2)+'" height="'+(youmaxWidgetWidth/youmax_global_options.youtubeVideoAspectRatio)+'" src="" frameborder="0" allowfullscreen></iframe><div id="youmax-video-list-div"></div><div id="youmax-load-more-div">VEJA +</div></div>');
	...
	showLoader = function() {
		...
		$('#youmax-video-list-div').append('<div style="text-align:center; height:200px; font:14px Calibri;"><br><br><br><br><br><br>carregando...</div>');
	},
	...
	prepareYoumax = function() {
		...
		*/
		...
		$('#youmax-load-more-div').click(function(){
			...
			var $youmaxLoadMoreDiv = $('#youmax-load-more-div');
			$youmaxLoadMoreDiv.html('CARREGANDO..');
